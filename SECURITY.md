...
This policy applies to **`Kenearos/Homeassistant`**. It is derived from our engineering
...
1. Email **kenearos@googlemail.com** with the subject prefix `[SECURITY] Homeassistant`.
...
| Version | Supported |
|---------|-----------|
| Latest release of `Homeassistant` | ✅ Yes |
